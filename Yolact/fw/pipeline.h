...
#define YOLACT_PERSON_SEGMENTATION_H
...
#define PROTOTYPE_MASK_WIDTH     28
#define PROTOTYPE_MASK_HEIGHT    28
#define MASK_COEFFICIENT         32
...
typedef struct
{
    float x, y, w, h;
    float score;
    float coefficients[MASK_COEFFICIENT];
}Box;
